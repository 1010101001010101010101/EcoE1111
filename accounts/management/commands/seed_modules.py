...
MODULES = [
    ...
    ("accounts",     "cuentas"),      # productos, categorías
    ("organizations", "Organización"),  # organizaciones, perfiles/usuarios org
]
...
APP_MODEL_MAP = {
    "operacion": {
        "app_label": "dispositivos",                         # ej: app "devices"
        "models": ["device", "measurement", "alert", "zone", "product", "category"],
    },
    "organizations": {
        "app_label": "accounts",                        # ej: app "accounts"
        "models": ["organization"],      # o "membership" si aplica
    },
    "accounts": {
        "app_label": "accounts",                        # ej: app "accounts"
