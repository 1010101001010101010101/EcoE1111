...
class Module(models.Model):
    code = models.SlugField(max_length=50, unique=True)  # 'ventas', 'empleados'
    name = models.CharField(max_length=100)              # 'Ventas', 'Empleados'
    icon = models.CharField(max_length=50, blank=True)   # opcional
